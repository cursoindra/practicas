...
public class CursoDelegate {
	...
	public void altaUsuario(String nombre, String apellido1, String apellido2, String dni, String fechaNacimiento,
			String email, String user, String clave,int rol) throws Exception {
	...
	public void actualizaUsuario(String nombre, String apellido1, String apellido2, String dni, String fechaNacimiento,
			String email, int rol,HttpSession session) throws Exception {
		Usuario usuario= new Usuario();
		usuario.setNombre(nombre);
		usuario.setApellido1(apellido1);
		usuario.setApellido2(apellido2);
		...
		Date date = new Date(fecha.getTimeInMillis());
		usuario.setFechaNacimiento(date);
		getCursoService().actualizaUsuario(usuario,session);
	}
